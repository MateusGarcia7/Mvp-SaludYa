...
form.addEventListener("submit", (e) => {
    ...
    if (!name || !email || !password || !genero || !edad || !confirmPassword || !documentType || !documentNumber) {
   ...
   // console.log(email, password, genero, edad, confirmPassword, documentType, documentNumber, name);
